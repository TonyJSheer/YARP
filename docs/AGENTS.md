...
All commands from repo root unless specified.
...
Full details in `coding_standards.md`. Key points:
...
Full guide: `database_conventions.md`
...
- No pagination needed in Phase 1 (small data volume)
- SSE streaming events: each event is a token string; final event is `[DONE]`

Full guide: `api_conventions.md`

---

## Git Conventions

Full guide: `git_conventions.md`. Key points:
